...
import { validateString, validateEmail, validatePhoneNumber, validateDate, validateHCPId, validateJobStatus, validateEmployeeRole, validateAppointmentStatus, validatePaginationParams, validateSchedule, validateLineItem, validateArray, MCP_TOOL_NAMES } from '../../hcp-mcp-common/src/index.js';
export class HCPMCPServer {
    ...
    async handleListCustomers(args) {
        ...
        if (args.search)
            params.search = validateString(args.search, 'search');
