// PRODUCTION Environment - Delete Job Script for Airtable
...
try {
    output.text('🗑️ Deleting job in PRODUCTION environment...');
    ...
    if (result.success) {
        output.text(`✅ PRODUCTION Job deleted successfully!`);
