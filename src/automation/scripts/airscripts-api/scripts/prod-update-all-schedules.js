// PRODUCTION Environment - Update All Schedules Script for Airtable
...
try {
    output.text('🔄 Updating all schedules in PRODUCTION environment...');
    ...
    if (result.success) {
        output.text(`✅ PRODUCTION Bulk schedule check completed!`);
